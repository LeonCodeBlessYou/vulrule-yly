---
title: xmlxpathfreecontext

---


## API Overview
**xmlxpathfreecontext** is an API in **libxml2**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
