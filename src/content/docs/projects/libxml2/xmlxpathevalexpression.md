---
title: xmlxpathevalexpression

---


## API Overview
**xmlxpathevalexpression** is an API in **libxml2**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
