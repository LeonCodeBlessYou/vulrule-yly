---
title: xmlschemavalpredeftypenodenonorm

---


## API Overview
**xmlschemavalpredeftypenodenonorm** is an API in **libxml2**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 3 must be freed when no longer needed.
