---
title: xmlcreatefileparserctxt

---


## API Overview
**xmlcreatefileparserctxt** is an API in **libxml2**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
