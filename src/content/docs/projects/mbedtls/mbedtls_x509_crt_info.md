---
title: mbedtls_x509_crt_info

---


## API Overview
**mbedtls_x509_crt_info** is an API in **mbedtls**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
