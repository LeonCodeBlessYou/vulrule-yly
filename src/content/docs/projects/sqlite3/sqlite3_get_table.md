---
title: sqlite3_get_table

---


## API Overview
**sqlite3_get_table** is an API in **sqlite3**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 6 must be freed when no longer needed.
