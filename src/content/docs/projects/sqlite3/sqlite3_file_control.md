---
title: sqlite3_file_control

---


## API Overview
**sqlite3_file_control** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
