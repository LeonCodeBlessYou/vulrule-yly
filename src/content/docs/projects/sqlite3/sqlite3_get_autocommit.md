---
title: sqlite3_get_autocommit

---


## API Overview
**sqlite3_get_autocommit** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
