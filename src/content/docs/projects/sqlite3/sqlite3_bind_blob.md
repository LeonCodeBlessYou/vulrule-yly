---
title: sqlite3_bind_blob

---


## API Overview
**sqlite3_bind_blob** is an API in **sqlite3**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 5 must be initialized.
