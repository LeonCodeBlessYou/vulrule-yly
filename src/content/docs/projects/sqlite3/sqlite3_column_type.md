---
title: sqlite3_column_type

---


## API Overview
**sqlite3_column_type** is an API in **sqlite3**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
