---
title: sqlite3_value_free

---


## API Overview
**sqlite3_value_free** is an API in **sqlite3**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
