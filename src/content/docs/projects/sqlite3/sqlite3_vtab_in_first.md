---
title: sqlite3_vtab_in_first

---


## API Overview
**sqlite3_vtab_in_first** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
