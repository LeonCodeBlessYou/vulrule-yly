---
title: sqlite3_result_double

---


## API Overview
**sqlite3_result_double** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
