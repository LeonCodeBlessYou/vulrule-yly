---
title: sqlite3_column_decltype16

---


## API Overview
**sqlite3_column_decltype16** is an API in **sqlite3**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
