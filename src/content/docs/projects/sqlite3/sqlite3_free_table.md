---
title: sqlite3_free_table

---


## API Overview
**sqlite3_free_table** is an API in **sqlite3**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
