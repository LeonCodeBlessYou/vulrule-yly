---
title: sqlite3_last_insert_rowid

---


## API Overview
**sqlite3_last_insert_rowid** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
