---
title: sqlite3_user_data

---


## API Overview
**sqlite3_user_data** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
