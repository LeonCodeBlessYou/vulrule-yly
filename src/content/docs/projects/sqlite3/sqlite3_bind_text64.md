---
title: sqlite3_bind_text64

---


## API Overview
**sqlite3_bind_text64** is an API in **sqlite3**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
