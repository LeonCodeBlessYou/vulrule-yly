---
title: sqlite3_declare_vtab

---


## API Overview
**sqlite3_declare_vtab** is an API in **sqlite3**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
