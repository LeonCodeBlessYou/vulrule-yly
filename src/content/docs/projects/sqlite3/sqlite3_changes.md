---
title: sqlite3_changes

---


## API Overview
**sqlite3_changes** is an API in **sqlite3**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
