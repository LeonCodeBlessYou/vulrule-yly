---
title: dbus_server_disconnect

---


## API Overview
**dbus_server_disconnect** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to dbus_server_disconnect, it must not be freed again.
