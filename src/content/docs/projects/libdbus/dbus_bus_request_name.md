---
title: dbus_bus_request_name

---


## API Overview
**dbus_bus_request_name** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 2-th argument to dbus_bus_request_name, it must not be freed again.
