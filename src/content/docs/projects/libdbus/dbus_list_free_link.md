---
title: dbus_list_free_link

---


## API Overview
**dbus_list_free_link** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to _dbus_list_free_link, it must not be freed again.
