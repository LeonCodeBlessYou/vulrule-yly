---
title: dbus_message_unref

---


## API Overview
**dbus_message_unref** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to dbus_message_unref, it must not be freed again.
