---
title: dbus_data_slot_allocator_free

---


## API Overview
**dbus_data_slot_allocator_free** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to _dbus_data_slot_allocator_free, it must not be freed again.
