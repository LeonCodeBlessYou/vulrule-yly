---
title: dbus_connection_unlock

---


## API Overview
**dbus_connection_unlock** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to _dbus_connection_unlock, it must not be freed again.
