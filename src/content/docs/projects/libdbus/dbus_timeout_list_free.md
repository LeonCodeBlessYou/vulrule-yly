---
title: dbus_timeout_list_free

---


## API Overview
**dbus_timeout_list_free** is an API in **libdbus**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to _dbus_timeout_list_free, it must not be freed again.
