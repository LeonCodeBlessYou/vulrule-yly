---
title: av_aes_ctr_free

---


## API Overview
**av_aes_ctr_free** is an API in **ffmpeg**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to av_aes_ctr_free, it must not be freed again.
