---
title: av_opt_free_ranges

---


## API Overview
**av_opt_free_ranges** is an API in **FFmpeg**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to av_opt_free_ranges, it must not be freed again.
