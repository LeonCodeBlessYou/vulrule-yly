---
title: pcap_dump_ftell

---


## API Overview
**pcap_dump_ftell** is an API in **libpcap**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
