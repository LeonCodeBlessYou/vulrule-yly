---
title: pcap_freealldevs

---


## API Overview
**pcap_freealldevs** is an API in **libpcap**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to pcap_freealldevs, it must not be freed again.
