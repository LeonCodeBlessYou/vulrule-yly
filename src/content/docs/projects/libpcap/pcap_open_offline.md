---
title: pcap_open_offline

---


## API Overview
**pcap_open_offline** is an API in **libpcap**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
