---
title: pcap_setnonblock

---


## API Overview
**pcap_setnonblock** is an API in **libpcap**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 3 must not be NULL.
