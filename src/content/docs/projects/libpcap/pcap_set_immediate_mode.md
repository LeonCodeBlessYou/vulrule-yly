---
title: pcap_set_immediate_mode

---


## API Overview
**pcap_set_immediate_mode** is an API in **libpcap**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
