---
title: pcap_get_selectable_fd

---


## API Overview
**pcap_get_selectable_fd** is an API in **libpcap**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
