---
title: ath10k_wmi_tlv_op_gen_vdev_set_param

---


## API Overview
**ath10k_wmi_tlv_op_gen_vdev_set_param** is an API in **Linux kernel**. This rule belongs to the **return value check** type. This rule is generated using [APISpecGen](../../tools/APISpecGen).
## Rule Description
