---
title: zip_unchange_all

---


## API Overview
**zip_unchange_all** is an API in **libzip**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
