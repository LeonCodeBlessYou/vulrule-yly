---
title: zip_file_attributes_init

---


## API Overview
**zip_file_attributes_init** is an API in **libzip**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
