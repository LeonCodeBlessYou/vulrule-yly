---
title: zip_error_system_type

---


## API Overview
**zip_error_system_type** is an API in **libzip**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
