---
title: zip_fopen_index_encrypted

---


## API Overview
**zip_fopen_index_encrypted** is an API in **libzip**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
