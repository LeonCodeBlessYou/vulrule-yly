---
title: zip_file_is_seekable

---


## API Overview
**zip_file_is_seekable** is an API in **libzip**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
