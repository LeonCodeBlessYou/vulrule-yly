---
title: zip_source_open

---


## API Overview
**zip_source_open** is an API in **libzip**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
