---
title: zip_error_to_data

---


## API Overview
**zip_error_to_data** is an API in **libzip**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
