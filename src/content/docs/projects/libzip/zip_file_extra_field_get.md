---
title: zip_file_extra_field_get

---


## API Overview
**zip_file_extra_field_get** is an API in **libzip**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 4 must be initialized.
