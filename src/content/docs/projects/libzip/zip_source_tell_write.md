---
title: zip_source_tell_write

---


## API Overview
**zip_source_tell_write** is an API in **libzip**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
