---
title: event_base_loopexit

---


## API Overview
**event_base_loopexit** is an API in **libevent**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
