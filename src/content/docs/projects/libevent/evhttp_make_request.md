---
title: evhttp_make_request

---


## API Overview
**evhttp_make_request** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
