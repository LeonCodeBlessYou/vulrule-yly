---
title: evutil_freeaddrinfo

---


## API Overview
**evutil_freeaddrinfo** is an API in **libevent**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to evutil_freeaddrinfo, it must not be freed again.
