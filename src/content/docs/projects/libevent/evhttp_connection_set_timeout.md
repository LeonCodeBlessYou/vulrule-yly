---
title: evhttp_connection_set_timeout

---


## API Overview
**evhttp_connection_set_timeout** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
