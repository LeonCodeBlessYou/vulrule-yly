---
title: evdns_base_resolve_ipv6

---


## API Overview
**evdns_base_resolve_ipv6** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 2 must not be NULL.
