---
title: evhttp_set_allowed_methods

---


## API Overview
**evhttp_set_allowed_methods** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
