---
title: evhttp_request_get_connection

---


## API Overview
**evhttp_request_get_connection** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
