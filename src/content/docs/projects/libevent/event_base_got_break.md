---
title: event_base_got_break

---


## API Overview
**event_base_got_break** is an API in **libevent**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
