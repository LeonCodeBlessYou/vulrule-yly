...
## API Overview
**evhttp_del_accept_socket** is an API in **libevent**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to evhttp_del_accept_socket, it must not be freed again.
