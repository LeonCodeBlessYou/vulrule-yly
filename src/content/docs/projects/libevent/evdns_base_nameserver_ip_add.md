---
title: evdns_base_nameserver_ip_add

---


## API Overview
**evdns_base_nameserver_ip_add** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
