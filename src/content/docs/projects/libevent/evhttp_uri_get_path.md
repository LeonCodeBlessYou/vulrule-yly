---
title: evhttp_uri_get_path

---


## API Overview
**evhttp_uri_get_path** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
