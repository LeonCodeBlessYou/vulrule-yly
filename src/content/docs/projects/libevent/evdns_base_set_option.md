---
title: evdns_base_set_option

---


## API Overview
**evdns_base_set_option** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
