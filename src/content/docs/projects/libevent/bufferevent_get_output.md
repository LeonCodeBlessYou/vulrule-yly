---
title: bufferevent_get_output

---


## API Overview
**bufferevent_get_output** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
