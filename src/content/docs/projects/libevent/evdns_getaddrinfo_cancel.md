...
## API Overview
**evdns_getaddrinfo_cancel** is an API in **libevent**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to evdns_getaddrinfo_cancel, it must not be freed again.
