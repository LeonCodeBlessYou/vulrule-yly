---
title: evutil_inet_ntop

---


## API Overview
**evutil_inet_ntop** is an API in **libevent**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
