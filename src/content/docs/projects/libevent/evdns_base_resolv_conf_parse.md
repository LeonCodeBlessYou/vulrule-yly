---
title: evdns_base_resolv_conf_parse

---


## API Overview
**evdns_base_resolv_conf_parse** is an API in **libevent**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
