...
## API Overview
**evhttp_connection_free_on_completion** is an API in **libevent**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to evhttp_connection_free_on_completion, it must not be freed again.
