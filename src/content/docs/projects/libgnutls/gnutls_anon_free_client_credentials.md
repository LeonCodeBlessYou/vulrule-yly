---
title: gnutls_anon_free_client_credentials

---


## API Overview
**gnutls_anon_free_client_credentials** is an API in **libgnutls**. This rule belongs to the **api pair** type. This rule is generated using [ChatDetector](../../tools/ChatDetector).
## Rule Description

:::tip

Once a resource is passed as the 1-th argument to gnutls_anon_free_client_credentials, it must not be freed again.
