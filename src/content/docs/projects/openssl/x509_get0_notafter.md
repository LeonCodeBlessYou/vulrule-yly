---
title: x509_get0_notafter

---


## API Overview
**x509_get0_notafter** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
