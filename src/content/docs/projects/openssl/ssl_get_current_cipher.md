---
title: ssl_get_current_cipher

---


## API Overview
**ssl_get_current_cipher** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
