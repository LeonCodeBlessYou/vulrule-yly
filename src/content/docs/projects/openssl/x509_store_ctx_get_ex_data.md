---
title: x509_store_ctx_get_ex_data

---


## API Overview
**x509_store_ctx_get_ex_data** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
