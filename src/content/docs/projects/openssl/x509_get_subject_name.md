---
title: x509_get_subject_name

---


## API Overview
**x509_get_subject_name** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
