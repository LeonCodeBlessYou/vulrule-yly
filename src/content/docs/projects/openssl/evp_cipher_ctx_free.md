---
title: evp_cipher_ctx_free

---


## API Overview
**evp_cipher_ctx_free** is an API in **openssl**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
