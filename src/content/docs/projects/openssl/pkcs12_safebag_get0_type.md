---
title: pkcs12_safebag_get0_type

---


## API Overview
**pkcs12_safebag_get0_type** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
