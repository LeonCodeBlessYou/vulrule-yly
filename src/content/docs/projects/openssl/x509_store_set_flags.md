---
title: x509_store_set_flags

---


## API Overview
**x509_store_set_flags** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
