---
title: ssl_get_default_timeout

---


## API Overview
**ssl_get_default_timeout** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
