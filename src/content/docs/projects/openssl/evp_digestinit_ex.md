---
title: evp_digestinit_ex

---


## API Overview
**evp_digestinit_ex** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
