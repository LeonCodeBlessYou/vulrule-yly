---
title: ssl_ctx_set_cipher_list

---


## API Overview
**ssl_ctx_set_cipher_list** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
