---
title: x509_store_ctx_set_error

---


## API Overview
**x509_store_ctx_set_error** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
