---
title: evp_pkey_get0_dh

---


## API Overview
**evp_pkey_get0_dh** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
