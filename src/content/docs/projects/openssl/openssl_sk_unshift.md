---
title: openssl_sk_unshift

---


## API Overview
**openssl_sk_unshift** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
