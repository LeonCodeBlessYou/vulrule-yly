---
title: evp_pkey_get_bn_param

---


## API Overview
**evp_pkey_get_bn_param** is an API in **openssl**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
