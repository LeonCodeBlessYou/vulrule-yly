---
title: evp_digestsigninit

---


## API Overview
**evp_digestsigninit** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
