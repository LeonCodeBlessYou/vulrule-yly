---
title: evp_pkey_new_mac_key

---


## API Overview
**evp_pkey_new_mac_key** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
