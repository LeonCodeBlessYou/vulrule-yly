---
title: openssl_sk_value

---


## API Overview
**openssl_sk_value** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
