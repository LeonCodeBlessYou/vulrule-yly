...
## API Overview
**bn_mod_exp_mont_consttime_x2** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description

:::tip

Parameter 9 must be initialized.
