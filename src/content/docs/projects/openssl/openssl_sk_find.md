---
title: openssl_sk_find

---


## API Overview
**openssl_sk_find** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
