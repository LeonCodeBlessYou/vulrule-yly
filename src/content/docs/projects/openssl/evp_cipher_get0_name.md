---
title: evp_cipher_get0_name

---


## API Overview
**evp_cipher_get0_name** is an API in **openssl**. This rule belongs to the **initialization** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
