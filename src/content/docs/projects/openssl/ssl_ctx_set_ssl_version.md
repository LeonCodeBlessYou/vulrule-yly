---
title: ssl_ctx_set_ssl_version

---


## API Overview
**ssl_ctx_set_ssl_version** is an API in **openssl**. This rule belongs to the **parameter check** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
