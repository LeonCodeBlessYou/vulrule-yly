---
title: x509_store_add_cert

---


## API Overview
**x509_store_add_cert** is an API in **openssl**. This rule belongs to the **api pair** type. This rule is generated using [GPTAid](../../tools/GPTAid).
## Rule Description
